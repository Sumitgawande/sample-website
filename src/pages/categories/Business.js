...
function Business(props) {
    return (
        <div>
            ...
            <h2 style={{ marginTop: '10px',textAlign: 'center'}}>Business posts</h2>
                    ...
                    <div className="category_cards_container">
                        <div className="category_cards__wrapper">
                            <ul className="category_cards__Items" >
                                <CardItem imgsrc='/responsive-hero.jpg'
                                    text="Explore the latest businss news"
